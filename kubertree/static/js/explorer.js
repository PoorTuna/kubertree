...
import { fmtAxis, kindBadge, efficiencyText, escapeHtml } from "./format.js";
...
function makeRow(node, opts, focus, depth) {
  ...
  row.innerHTML = `
    <div class="ex-name" style="padding-left:${indent}px">
      ...
      <span class="ex-badge" data-kind="${escapeHtml(node.data.kind)}">${kindBadge(node.data.kind)}</span>
